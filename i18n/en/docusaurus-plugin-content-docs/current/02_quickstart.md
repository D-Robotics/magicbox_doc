...
### Method 1: Flash Link Configuration Instructions
...
Press the leftmost button—the indicator light turns red. Then, open a web browser and visit `http://192.168.127.10:8000` to view the effect.

![Stereo Depth Estimation](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/magicbox/zh/Depth-Estimation.png)

### Gesture Interaction

Press the middle button—the indicator light turns green. Visit `http://192.168.127.10:8000` in your browser to view the effect and interact.

| Gesture      | Hand Motion         | Triggered Action     |
|--------------|---------------------|----------------------|
| ThumbUp      | Thumbs-up           | Ears wiggle          |
| Victory      | "V" sign            | Feet lift up         |
| ThumbLeft    | Thumb points left   | Left hand raises     |
| ThumbRight   | Thumb points right  | Right hand raises    |
| Okay         | "OK" gesture        | Lights flash         |
...
The resource monitoring feature starts automatically upon power-up. Visit `http://192.168.127.10:7999` in your browser to view real-time resource usage, including CPU, BPU, and more.
